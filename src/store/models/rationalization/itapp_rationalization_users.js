// To parse this data:
//
//   const Convert = require("@/store/models/rationalization/itapp_rationalization_users");
//
//   const rationalizationUser = Convert.toRationalizationUser(json);
//
...
function toRationalizationUser(json) {
  return cast(json, a(r('RationalizationUser')))
}
...
const typeMap = {
  'RationalizationUser': o([
    { json: 'id', js: 'id', typ: u(undefined, 0) },
    { json: 'app_id', js: 'app_id', typ: u(undefined, 0) },
    { json: 'users', js: 'users', typ: u(undefined, 0) },
...
module.exports = {
  'toRationalizationUser': toRationalizationUser
}
