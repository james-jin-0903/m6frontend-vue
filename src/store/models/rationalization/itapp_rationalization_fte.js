// To parse this data:
//
//   const Convert = require("@/store/models/rationalization/itapp_rationalization_fte");
//
//   const rationalizationFte = Convert.toRationalizationFte(json);
//
...
function toRationalizationFte(json) {
  return cast(json, a(r('RationalizationFte')))
}
...
const typeMap = {
  'RationalizationFte': o([
    { json: 'id', js: 'id', typ: u(undefined, 0) },
    { json: 'app_id', js: 'app_id', typ: u(undefined, 0) },
    { json: 'fte_count', js: 'fte_count', typ: u(undefined, 0) },
    { json: 'fte_costs', js: 'fte_costs', typ: u(undefined, 0) },
...
module.exports = {
  'toRationalizationFte': toRationalizationFte
}
