<template>
  ...
  >
    ...
    >
      ...
      >
        <body
          class="knob-control__text-display svg-text-body"
          :style="styleForeighObject"
          v-html="valueDisplay"
        />
      </foreignObject>
    </svg>
  ...
  computed: {
    ...
    valueDisplay() {
      if (this.animation.animateValue) {
        ...
        return this.valueDisplayFunction(this.valueToDisplay !== null ? this.valueToDisplay : this.value)
      }
    }
  },
  mounted() {
