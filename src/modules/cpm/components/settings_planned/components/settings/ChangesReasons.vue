...
export default {
  ...
  methods: {
    ...
    create() {
      this.reasonsRef.add(this.element)
        .then(() => {
    ...
    update() {
      ...
      this.reasonsRef.doc(this.element.id).update(this.element)
        .then(() => {
          this.$snotify.success('The Changes Reason has been updated', 'Success')
          this.cancel()
        })
        .catch(() => {
    ...
    submitDelete() {
      ...
      this.reasonsRef
        ...
        .delete()
        .then(() => {
          this.$snotify.success('The Changes Reason has been deleted', 'Success')
